...
# The method should return the element of the array that is equal to half of the sum of all elements 
# of the array. If there is no such element, the method should return nil.
